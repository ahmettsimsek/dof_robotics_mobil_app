...
function AerobaticsScreen  () {

  const navigation = useNavigation();

  return (
    <SafeAreaView style={styles.container}>
      <Text style={styles.textContainer}> Aerobatics</Text>
      <View style={styles.imageContainer}>
        <Image
          source={{ uri: 'https://dofrobotics.com/storage/movies/Lf8HXFxxbqDi1opBMpa2wNuL57vRJEkqTZDBRbaN.jpg' }}
          style={styles.image}
        />

        <Text style={styles.textContainer2}>Aerobatics </Text>
...
export default AerobaticsScreen

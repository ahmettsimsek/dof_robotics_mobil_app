...
function DinoIslandScreen  () {

  const navigation = useNavigation();

  return (
    <SafeAreaView style={styles.container}>
      <Text style={styles.textContainer}> Dino Island</Text>
      <View style={styles.imageContainer}>
        <Image
          source={{ uri: 'https://dofrobotics.com/storage/movies/3oepwJQxFOAbHgSQazZQsasdv7UUGKsPtO8BHMHx.jpg' }}
          style={styles.image}
        />

        <Text style={styles.textContainer2}>Dino Island </Text>
...
export default DinoIslandScreen

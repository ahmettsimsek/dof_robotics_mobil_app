...
function HotPursuit2Screen  () {

  const navigation = useNavigation();

  return (
    <SafeAreaView style={styles.container}>
      <Text style={styles.textContainer}> Hot Pursuit 2</Text>
      <View style={styles.imageContainer}>
        <Image
          source={{ uri: 'https://dofrobotics.com/storage/movies/6w1QNbmY6E1F2GDuQr3Q7nXcleqe5A9mQIfvVkTu.jpg' }}
          style={styles.image}
        />

        <Text style={styles.textContainer2}>Hot Pursuit 2</Text>
...
export default HotPursuit2Screen

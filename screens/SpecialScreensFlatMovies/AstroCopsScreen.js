...
function AstroCopsScreen  () {

  const navigation = useNavigation();

  return (
    <SafeAreaView style={styles.container}>
      <Text style={styles.textContainer}> Astro Cops</Text>
      <View style={styles.imageContainer}>
        <Image
          source={{ uri: 'https://dofrobotics.com/storage/movies/T3RW5mzasRBgMO6S2pFT9U7PMCYXKLCeyWleCPmw.jpg' }}
          style={styles.image}
        />

        <Text style={styles.textContainer2}>Astro Cops </Text>
...
export default AstroCopsScreen

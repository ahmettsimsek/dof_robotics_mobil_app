...
function MagicWorldScreen  () {

  const navigation = useNavigation();

  return (
    <SafeAreaView style={styles.container}>
      <Text style={styles.textContainer}>Magic World</Text>
      <View style={styles.imageContainer}>
        <Image
          source={{ uri: 'https://dofrobotics.com/storage/movies/ROZ2MvMnXjE8ZNLuiqHFwzqSuTgY72cHuPzRK67a.jpg' }}
          style={styles.image}
        />

        <Text style={styles.textContainer2}>Magic World</Text>
...
export default MagicWorldScreen

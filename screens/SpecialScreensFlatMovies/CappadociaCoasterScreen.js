...
function CappadociaCoasterScreen  () {

  const navigation = useNavigation();

  return (
    <SafeAreaView style={styles.container}>
      <Text style={styles.textContainer}>Cappadocia Coaster</Text>
      <View style={styles.imageContainer}>
        <Image
          source={{ uri: 'https://dofrobotics.com/storage/movies/guh0erqgMDxuq86fDLHJdWeiwD5UQepdAxHbXBM6.jpg' }}
          style={styles.image}
        />

        <Text style={styles.textContainer2}>Cappadocia Coaster</Text>
...
export default CappadociaCoasterScreen

  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.imageContainer}>
        <Image
          source={{ uri: 'https://dofrobotics.com/storage/movies/ye3orNSpeHSMHeLbEoTlU8Na8UW3p0zjBKcwHN7X.jpg' }}
          style={styles.image}
        />
...
export default IslandCoasterScreen

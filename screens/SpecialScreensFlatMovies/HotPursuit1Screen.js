...
function HotPursuit1Screen  () {

  const navigation = useNavigation();

  return (
    <SafeAreaView style={styles.container}>
      <Text style={styles.textContainer}> Hot Pursuit 1</Text>
      <View style={styles.imageContainer}>
        <Image
          source={{ uri: 'https://dofrobotics.com/storage/movies/CBK9mVqrU2CxtPdeIfS7C3ol9NG6M1AS4lCclmZZ.jpg' }}
          style={styles.image}
        />

        <Text style={styles.textContainer2}>Hot Pursuit 1</Text>
...
export default HotPursuit1Screen

  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.imageContainer}>
        <Image
          source={{ uri: 'https://dofrobotics.com/storage/movies/tzfspQ51LeZl3ERYxmgjyoVPMHQc5AwKIxkfk9Tt.jpg' }}
          style={styles.image}
        />
...
export default WallofChinaScreen

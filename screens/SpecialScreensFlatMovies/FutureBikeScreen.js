...
function FutureBikeScreen  () {

  const navigation = useNavigation();

  return (
    <SafeAreaView style={styles.container}>
      <Text style={styles.textContainer}> Future Bike</Text>
      <View style={styles.imageContainer}>
        <Image
          source={{ uri: 'https://dofrobotics.com/storage/movies/NHexxZIqQHkN3CgN1eQbYcFGmPyFAlvrjCzFHRFI.jpg' }}
          style={styles.image}
        />

        <Text style={styles.textContainer2}>Future Bike</Text>
...
export default FutureBikeScreen

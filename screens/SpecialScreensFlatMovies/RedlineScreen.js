...
function RedlineScreen  () {

  const navigation = useNavigation();

  return (
    <SafeAreaView style={styles.container}>
      <Text style={styles.textContainer}>Redline</Text>
      <View style={styles.imageContainer}>
        <Image
          source={{ uri: 'https://dofrobotics.com/storage/movies/EcpRBMh7j6ovdx5v6w39219j1wM8AKF1z2PDPxNX.jpg' }}
          style={styles.image}
        />

        <Text style={styles.textContainer2}>Redline</Text>

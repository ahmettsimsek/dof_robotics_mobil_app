...
function LostWorldScreen  () {

  const navigation = useNavigation();

  return (
    <SafeAreaView style={styles.container}>
      <Text style={styles.textContainer}>Lost World</Text>
      <View style={styles.imageContainer}>
        <Image
          source={{ uri: 'https://dofrobotics.com/storage/movies/ZePWlwbndIbFZebdCZDOAE58Em4fV5dO6aLWNDYS.jpg' }}
          style={styles.image}
        />

        <Text style={styles.textContainer2}>Lost World</Text>
...
export default LostWorldScreen

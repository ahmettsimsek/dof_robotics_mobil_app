...
function PenguinsScreen  () {

  const navigation = useNavigation();

  return (
    <SafeAreaView style={styles.container}>
      <Text style={styles.textContainer}>Penguins</Text>
      <View style={styles.imageContainer}>
        <Image
          source={{ uri: 'https://dofrobotics.com/storage/movies/PWoW8ZgfmE07RaXEvqLgSXyeWHy8zehY4DDB6hUr.jpg' }}
          style={styles.image}
        />

        <Text style={styles.textContainer2}>Penguins</Text>

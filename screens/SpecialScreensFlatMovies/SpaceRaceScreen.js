...
function SpaceRaceScreen  () {

  const navigation = useNavigation();

  return (
    <SafeAreaView style={styles.container}>
      <Text style={styles.textContainer}>Space Race</Text>
      <View style={styles.imageContainer}>
        <Image
          source={{ uri: 'https://dofrobotics.com/storage/movies/TkrsVcFBpk03oMKOR8BNIOP0GaIZCpJoDF66zjVO.jpg' }}
          style={styles.image}
        />

        <Text style={styles.textContainer2}>Space Race</Text>
...
export default SpaceRaceScreen

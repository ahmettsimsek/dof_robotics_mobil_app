...
function PlanetScreen  () {
  ...
  return (
    <SafeAreaView style={styles.container}>
      <Text style={styles.textContainer}>Planet</Text>
      <View style={styles.imageContainer}>
        <Image
          source={{ uri: 'https://dofrobotics.com/storage/movies/ImcK9VtklNbMye7vkQbmgI6Uj48rnvFzpd7lGwJr.jpg' }}
          style={styles.image}
        />

        <Text style={styles.textContainer2}>Planet</Text>
...
const styles = StyleSheet.create({
  ...
  image: {
    width: 300,  // Daha iyi görüntülenmesi için genişlik ayarlandı
    height: 495,

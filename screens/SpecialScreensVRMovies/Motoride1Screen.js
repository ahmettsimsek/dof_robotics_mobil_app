...
function Motoride1Screen  () {

  const navigation = useNavigation();

  return (
    <SafeAreaView style={styles.container}>
      <Text style={styles.textContainer}>Motoride 1</Text>
      <View style={styles.imageContainer}>
        <Image
          source={{ uri: 'https://dofrobotics.com/storage/movies/hdNvd4b7UkxvPaNn0viy6W96sXHovminpx4nKz4M.jpg' }}
          style={styles.image}
        />

        <Text style={styles.textContainer2}>Motoride 1</Text>
...
export default Motoride1Screen

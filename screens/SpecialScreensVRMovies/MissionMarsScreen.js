  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.imageContainer}>
        <Image
          source={{ uri: 'https://dofrobotics.com/storage/movies/RbT0SxvFEboBO4riqrLfrODVYfXDEU2Z9i4ncFey.jpg' }}
          style={styles.image}
        />
...
export default MissionMarsScreen

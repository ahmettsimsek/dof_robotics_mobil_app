...
function ArabianNightsScreen  () {

  const navigation = useNavigation();

  return (
    <SafeAreaView style={styles.container}>
      <Text style={styles.textContainer}> Arabian Nights</Text>
      <View style={styles.imageContainer}>
        <Image
          source={{ uri: 'https://dofrobotics.com/storage/movies/f20iYluAebRpYgazXmqsx8yhAZXpKx4Rb5tIxORn.jpg' }}
          style={styles.image}
        />

        <Text style={styles.textContainer2}>Arabian Nights</Text>
...
export default ArabianNightsScreen

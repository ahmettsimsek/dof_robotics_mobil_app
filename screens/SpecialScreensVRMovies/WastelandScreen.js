...
function WastelandScreen  () {
  ...
  return (
    <SafeAreaView style={styles.container}>
      <Text style={styles.textContainer}>Wasteland</Text>
      <View style={styles.imageContainer}>
        <Image
          source={{ uri: 'https://dofrobotics.com/storage/movies/JGAEfeRdMjugkhMquqXO5snYBatfADtMu2qFviY9.jpg' }}
          style={styles.image}
        />

        <Text style={styles.textContainer2}>Wasteland</Text>
...
export default WastelandScreen

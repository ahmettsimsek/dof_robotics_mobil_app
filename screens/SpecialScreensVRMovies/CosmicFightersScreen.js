...
function CosmicFightersScreen  () {

  const navigation = useNavigation();

  return (
    <SafeAreaView style={styles.container}>
      <Text style={styles.textContainer}>Cosmic Fighters</Text>
      <View style={styles.imageContainer}>
        <Image
          source={{ uri: 'https://dofrobotics.com/storage/movies/Geyg9t5tXa5P04YJpp0QZ4irBCD0PQ0uCtuNEcN6.jpg' }}
          style={styles.image}
        />

        <Text style={styles.textContainer2}>Cosmic Fighters</Text>
...
export default CosmicFightersScreen

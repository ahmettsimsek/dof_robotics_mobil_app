...
function DinoCoasterScreen  () {

  const navigation = useNavigation();

  return (
    <SafeAreaView style={styles.container}>
      <Text style={styles.textContainer}>Dino Coaster</Text>
      <View style={styles.imageContainer}>
        <Image
          source={{ uri: 'https://dofrobotics.com/storage/movies/qGn5KtsSjNjdax8LobTamV8pDlQXxgiaD98V8Y43.jpg' }}
          style={styles.image}
        />

        <Text style={styles.textContainer2}>Dino Coaster</Text>
...
export default DinoCoasterScreen

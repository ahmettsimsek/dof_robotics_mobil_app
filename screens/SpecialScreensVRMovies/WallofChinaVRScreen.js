  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.imageContainer}>
        <Image
          source={{ uri: 'https://dofrobotics.com/storage/movies/yugJOrd92Gzcy4nNT1B1BO5xDgJlorQiZWXFtnrW.jpg' }}
          style={styles.image}
        />
...
export default WallofChinaVRScreen

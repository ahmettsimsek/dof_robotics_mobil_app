...
function IslandCoasterVRScreen  () {
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.imageContainer}>
        <Image
          source={{ uri: 'https://dofrobotics.com/storage/movies/vBvDD3Jh09nmMPLZHskEL1NbWex6SjvyWlW3CDGn.jpg' }}
          style={styles.image}
        />
...
export default IslandCoasterVRScreen

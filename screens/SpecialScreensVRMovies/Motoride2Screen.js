...
function Motoride2Screen  () {

  const navigation = useNavigation();

  return (
    <SafeAreaView style={styles.container}>
      <Text style={styles.textContainer}>Motoride 2</Text>
      <View style={styles.imageContainer}>
        <Image
          source={{ uri: 'https://dofrobotics.com/storage/movies/pXMnxm1pZMSk75TPqQLJvUG80EnbBDztiaN6yZSV.jpg' }}
          style={styles.image}
        />

        <Text style={styles.textContainer2}>Motoride 2</Text>
...
export default Motoride2Screen

...
function PinocchioScreen  () {

  const navigation = useNavigation();

  return (
    <SafeAreaView style={styles.container}>
      <Text style={styles.textContainer}>Pinocchio</Text>
      <View style={styles.imageContainer}>
        <Image
          source={{ uri: 'https://dofrobotics.com/storage/movies/KW0Pa858pNa839mMvxw6TorJtKamjlN5a8Mh6xbf.jpg' }}
          style={styles.image}
        />

        <Text style={styles.textContainer2}>Pinocchio</Text>
...
export default PinocchioScreen

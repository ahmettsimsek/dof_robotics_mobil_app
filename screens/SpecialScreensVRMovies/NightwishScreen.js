...
function NightwishScreen  () {

  const navigation = useNavigation();

  return (
    <SafeAreaView style={styles.container}>
      <Text style={styles.textContainer}>Nigthwish</Text>
      <View style={styles.imageContainer}>
        <Image
          source={{ uri: 'https://dofrobotics.com/storage/movies/tA6CVFjLHR2EjbWnNnA6PtMXQUw9pOPdY0o0HZ1J.jpg' }}
          style={styles.image}
        />

        <Text style={styles.textContainer2}>Nigthwish</Text>
...
export default NightwishScreen

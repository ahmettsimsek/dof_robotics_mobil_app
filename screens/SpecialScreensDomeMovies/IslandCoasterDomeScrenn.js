...
function IslandCoasterDemoScrenn  () {

  const navigation = useNavigation();

  return (
    <SafeAreaView style={styles.container}>
      <Text style={styles.textContainer}> Island Coaster </Text>
      <View style={styles.imageContainer}>
        <Image
          source={{ uri: 'https://dofrobotics.com/storage/movies/swbda3KWTgAGcrNkWNpvikfAWrnMLkJVdp8HJV70.jpg' }}
          style={styles.image}
        />

        <Text style={styles.textContainer2}>Island Coaster </Text>
        <Text style={styles.textContainer3}>DOME</Text>
...
export default IslandCoasterDemoScrenn

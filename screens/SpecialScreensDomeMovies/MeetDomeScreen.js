...
function MeetDomeScreen  () {

  const navigation = useNavigation();

  return (
    <SafeAreaView style={styles.container}>
      <Text style={styles.textContainer}> Meet </Text>
      <View style={styles.imageContainer}>
        <Image
          source={{ uri: 'https://dofrobotics.com/storage/movies/shsj2UPpNfiUiyvUKb81uOdIY2AsBbfok7AId3b5.jpg' }}
          style={styles.image}
        />

        <Text style={styles.textContainer2}>Meet </Text>

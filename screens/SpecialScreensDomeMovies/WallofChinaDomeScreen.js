...
function WallofChinaDomeScreen  () {

  const navigation = useNavigation();

  return (
    <SafeAreaView style={styles.container}>
      <Text style={styles.textContainer}> Wall of China </Text>
      <View style={styles.imageContainer}>
        <Image
          source={{ uri: 'https://dofrobotics.com/storage/movies/yHDT5uaUXzDgy9qGE9Rv7QDzvWtm3jGQDWyoB1G8.jpg' }}
          style={styles.image}
        />

        <Text style={styles.textContainer2}>Wall of China </Text>
...
export default WallofChinaDomeScreen

...
function EscapeDomeScreen  () {

  const navigation = useNavigation();

  return (
    <SafeAreaView style={styles.container}>
      <Text style={styles.textContainer}> Escape </Text>
      <View style={styles.imageContainer}>
        <Image
          source={{ uri: 'https://dofrobotics.com/storage/movies/omo8BCBqa1bZEuXuO43FxNabarIAdSRHEmERPA0q.jpg' }}
          style={styles.image}
        />

        <Text style={styles.textContainer2}>Escape </Text>
...
export default EscapeDomeScreen

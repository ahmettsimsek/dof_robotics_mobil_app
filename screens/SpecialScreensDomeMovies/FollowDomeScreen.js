...
function FollowDomeScreen  () {

  const navigation = useNavigation();

  return (
    <SafeAreaView style={styles.container}>
      <Text style={styles.textContainer}> Follow </Text>
      <View style={styles.imageContainer}>
        <Image
          source={{ uri: 'https://dofrobotics.com/storage/movies/tjFyiOT2fTvjaBcmLYDOoOupEqDx8RhB0r84LsyD.jpg' }}
          style={styles.image}
        />

        <Text style={styles.textContainer2}>Follow </Text>
...
export default FollowDomeScreen

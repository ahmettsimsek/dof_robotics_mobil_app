...
function MissionMarsDomeScreen  () {

  const navigation = useNavigation();

  return (
    <SafeAreaView style={styles.container}>
      <Text style={styles.textContainer}> Mission Mars </Text>
      <View style={styles.imageContainer}>
        <Image
          source={{ uri: 'https://dofrobotics.com/storage/movies/tehm2CNCtaQHba2W2a9B3Pw7ohZrLEev1aZ6IwVr.jpg' }}
          style={styles.image}
        />

        <Text style={styles.textContainer2}>Mission Mars </Text>
...
export default MissionMarsDomeScreen

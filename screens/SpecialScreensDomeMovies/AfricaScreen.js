...
function AfricaScreen  () {
  ...
  return (
    <SafeAreaView style={styles.container}>
      <Text style={styles.textContainer}> Africa </Text>
      <View style={styles.imageContainer}>
        <Image
          source={{ uri: 'https://dofrobotics.com/storage/movies/v0jB0CvAHI7ma2WaPEiO97bDhY2cUiLAxvv0RQ5L.jpg' }}
          style={styles.image}
        />

        <Text style={styles.textContainer2}>Africa </Text>
